      ...
      {aiEmployees.length === 0 ? (
        ...
        <div className="space-y-4">
          {aiEmployees.map((employee, index) => {
            ...
            const getLanguageDisplay = (greetingMessage) => {
              if (!greetingMessage) return "N/A";
              
              const languages = Object.keys(greetingMessage);
              if (languages.length > 1) {
                // If multilingual key exists, or multiple languages
                return "Multilingual";
            ...
            return (
              <div
                ...
                className={`${currentTheme.cardBg} rounded-lg p-4 md:p-5 border ${currentTheme.border} hover:shadow-md transition-all duration-200`}
              >
                {/* Header Section */}
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className={`font-semibold ${currentTheme.text} text-lg mb-1`}>
                  ...
                  <button
                    ...
                    className={`px-3 py-2 ${currentTheme.searchBg} hover:${currentTheme.hover} ${currentTheme.text} border ${currentTheme.border} text-sm font-medium rounded-lg transition-all duration-200 flex items-center gap-2`}
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <p className={`${currentTheme.text} text-sm font-medium capitalize`}>
    ...
    <div className="space-y-4 md:space-y-6 px-2 sm:px-0">
      ...
      <div className="relative -mx-2 sm:mx-0">
        <div className="flex md:grid md:grid-cols-3 gap-3 md:gap-4 overflow-x-auto scrollbar-hide px-2 sm:px-0 snap-x snap-mandatory">
          {/* Total Clients Card */}
          <div
            className={`${currentTheme.cardBg} border ${currentTheme.border} rounded-lg p-4 md:p-6 shadow-lg min-w-[200px] sm:min-w-[240px] md:min-w-0 snap-center flex-shrink-0`}
          >
            <div className="flex items-start space-x-3 md:space-x-4">
              <div
                className={`p-2 md:p-3 bg-gray-50 rounded-lg flex-shrink-0`}
              >
                <Users className={`w-5 h-5 md:w-6 md:h-6 text-gray-900`} />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <h3
                    className={`text-xl md:text-2xl font-bold ${currentTheme.text} leading-none`}
                  >
          ...
          >
            <div className="flex items-start space-x-3 md:space-x-4">
              <div
                className={`p-2 md:p-3 bg-gray-50 rounded-lg flex-shrink-0`}
              >
                <Check className={`w-5 h-5 md:w-6 md:h-6 text-gray-900`} />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <h3
